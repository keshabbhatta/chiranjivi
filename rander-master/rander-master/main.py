...
def helper(dis):
    ...
    pre = pre.values.flatten().tolist()  # Flatten the array to a list
...
symptoms_dict = {
    ...
    'foul_smell_of urine': 90, 'continuous_feel_of_urine': 91, 
...
diseases_list = {
    ...
    33: 'Peptic ulcer disease', 1: 'AIDS', 12: 'Diabetes ', 
    ...
    29: 'Malaria', 8: 'Chicken pox', 11: 'Dengue', 
    37: 'Typhoid', 40: 'Hepatitis A', 19: 'Hepatitis B', 
    20: 'Hepatitis C', 21: 'Hepatitis D', 22: 'Hepatitis E', 
    3: 'Alcoholic hepatitis', 36: 'Tuberculosis', 
    10: 'Common Cold', 34: 'Pneumonia', 
    13: 'Dimorphic hemorrhoids (piles)', 
    18: 'Heart attack', 39: 'Varicose veins', 
    26: 'Hypothyroidism', 24: 'Hyperthyroidism', 
    25: 'Hypoglycemia', 31: 'Osteoarthritis', 5: 'Arthritis', 
    0: '(vertigo) Paroxysmal Positional Vertigo', 
    2: 'Acne', 38: 'Urinary tract infection', 
...
def get_symptoms():
    return jsonify(list(symptoms_dict.keys())), 200
